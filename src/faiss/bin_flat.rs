...
impl BinFlatIndex {
    ...
    pub fn search_with_bitset(
        ...
        for q in 0..nq {
            ...
            self.search_with_heap_and_bitset(
                query,
                k,
                bitset,
                &mut dists[output_offset..],
    ...
    fn search_with_heap_and_bitset(
        &self,
        query: &[u8],
        k: usize,
        bitset: &BitsetView,
...
mod tests {
    ...
    fn test_hamming_distance_correctness() {
        ...
        index
            .add(3, &[v1, v2, v3].concat(), Some(&[0, 1, 2]))
            .unwrap();
