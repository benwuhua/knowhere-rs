...
fn build_index_cache_path(
    ...
    cache_dir.map(|dir| {
        dir.join(format!(
            "diskann_pq{}_b{}_d{}_r{}_cl{}_sat{}_intra{}_entry{}_slack{}.dann",
            pq_dims,
            base_size,
            dim,
            max_degree,
...
mod tests {
    ...
    fn build_index_cache_path_has_stable_name() {
        ...
        assert_eq!(
            p.to_string_lossy(),
            "tmp/diskann_pq4_b30000_d128_r48_cl128_sat1_intra8_entry1_slack100.dann"
        );
    }
}
