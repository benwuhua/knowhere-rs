...
struct RsSampledSearchCostTailQuery {
    ...
    frontier_pops: usize,
    entry_descent_calls: usize,
    upper_layer_query_distance_calls: usize,
    query_l2_norm: f64,
    ...
    if let Some(candidate_profile_output) = candidate_profile_output {
        ...
        for i in 0..sampled_query_count {
            ...
            sampled_rows.push(RsSampledSearchCostTailQuery {
                ...
                entry_descent_calls: diagnosis.entry_descent_calls,
                upper_layer_query_distance_calls: diagnosis.upper_layer_query_distance_calls,
