...
Last updated: 2026-03-12 07:05 UTC
...
- 🔄 `HNSW-REOPEN-001`: HNSW has been intentionally reopened as the only active algorithm line.
  ...
  - The next direct algorithm rework in `src/faiss/hnsw.rs` should therefore target build-time candidate search first, with neighbor diversification as the secondary follow-up rather than treating repair or layer descent as the main blocker.
